...
<head>
    ...
    <title>@yield('title') - WonderCode</title>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('template-admin/node_modules/jqvmap/dist/jqvmap.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('template-admin/assets/js/stisla.js') }}"></script>

    <!-- JS Libraies -->
    <script src="{{ asset('template-admin/node_modules/simpleweather/jquery.simpleWeather.min.js') }}"></script>
    <script src="{{ asset('template-admin/node_modules/chart.js/dist/Chart.min.js') }}"></script>
    <script src="{{ asset('template-admin/node_modules/jqvmap/dist/jquery.vmap.min.js') }}"></script>
    ...
    <script src="{{ asset('template-admin/assets/js/page/index-0.js') }}"></script>
</body>
